...
["n3ds"]="retroarch --fullscreen -L /Applications/libretro_cores/azahar_libretro.so \"${ROM}\"" \
...
["psvita"]="/Applications/launchers/vita3k.sh -F -r \"${ROM}\"" \
...
["ps3"]="launch_ps3  \"${ROM}\"" \
["ps4"]="/Applications/launchers/shadps4.sh --fullscreen true -g \"${ROM}\"" \
